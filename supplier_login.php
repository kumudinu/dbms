...
if(isset($_POST['submit'])){
   ...
   $sql = "INSERT INTO dbms.supplier(`user_id`, `sup_name`, `sup_ph`, `dt`, `password`) VALUES ('000',  '$name', '$phoneNumber', current_timestamp(),'$password1');";
...
<div class="login">
       ...
       <div class="h-blur">
        ...
        <?php
        if($insert==true){
          echo "<h4>Your Signed Up </h4>";
          while ($row = $res->fetch_assoc()) {
            echo "<h4>Your User ID is <h4>" . $row['sup_id']."<br>";
        }
        }
        ?>
        </div>
       <form action="supplier_login.php" method="post">
