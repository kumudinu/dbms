...
$row3 = mysqli_fetch_assoc($result3);
   ...
   if($num1 != NULL) {
      $sql2 = "UPDATE orders SET pgm_id = '$name' WHERE rest_id = 0 AND pgm_id = 0";
      $result2 = mysqli_query($con, $sql2);
  
      $sql2 = "UPDATE `events` SET available = 1 WHERE pgm_id = '$name'";
      $result2 = mysqli_query($con, $sql2);
    }   


    
$test = "SELECT * FROM `events` WHERE pgm_id = '$name'";
...
<form action="event_signup.php" method="post">
          <input type="id" name="id" id="id" placeholder="Enter your User ID"  style="  margin-left: 620px; padding: 10px 60px;
          margin-top: 30px; color:black; background-color:white">
            
            <button name = "submit" id = "submit"  style="margin-top: 30px; margin-left: 690px;color:black; background-color:white;border: 2px solid black;width: 10%;
  padding: 6px 0px;
  outline: none;
