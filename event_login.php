...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "SELECT * FROM events where pgm_name='$name' AND password = '$password1' ";
...
<form action="event_login.php" method="post">
          ...
          <input type="password" name="password" id="password" placeholder="Enter your password"  style="  margin-left: 620px;color:black;
          margin-top: 30px; background-color:white;padding: 10px 60px;">
            
            <button id="id" name="id" class="btn-transparent" style="margin-top: 30px; margin-left: 690px;color:black; background-color:white;border: 2px solid black;width: 10%;
  padding: 6px 0px;
  outline: none;
