<?php
 ...
 $sql = "SELECT * FROM `orphanage` WHERE orph_name = '$name' AND password = '$password1'";
...
<div class="login">
       ...
       <form action="orphanage_login.php" method="post">
      ...
      <a href="orphanage_signup.php" style="font-size: 19px ; color:white">Sign Up</a>
  </div>
