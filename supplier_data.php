...
if($_SERVER["REQUEST_METHOD"] == "POST"){
 ...
 $sql = "SELECT * FROM `supplier` WHERE sup_id = '$name'";
...
<form action="welcome_supplier.php" method="post">
          <input type="name" name="name" id="name" placeholder="Enter your ID" class="input" style="  margin-left: 150px;
          margin-top: 30px;">
            
            <button name="go" class="btn-transparent" style="margin-top: 30px; margin-left: -10px;">Submit</button> 
      </form>
</div>
